...
class SegmentedButton : RadioGroup, View.OnClickListener {
    ...
    private fun RadioButton.initSegment(
        ...
        layoutParams = LayoutParams(
            when (spreadType) {
                SegmentSpreadType.evenly -> LayoutParams.MATCH_PARENT
                SegmentSpreadType.wrap -> LayoutParams.WRAP_CONTENT
            }, segmentHeight, 1f
        )
    ...
    private fun buildSegmentShape(type: SegmentType, color: Int) = buildShape(type, color, rI, r)
